...
TOKEN = '7685063460:AAGkPdgDV_V0JTCo2kOQUkToeMw2Ik7qlOE'  # Replace with your actual bot token
ADMIN_IDS = [930577300]  # Added new admin ID
CHANNEL_ID = '-1002313960365' # Replace with your specific channel or group ID
# Initialize the bot
...
EXEMPTED_USERS = [930577300, 6875416990, 7265902997]
...
def show_help(message):
    response = (
        ...
        "💀 `/CXT` - 🎯 *Launch your attack!* *(Verified users only)*\n"
        "📸 *Send a Photo* - 🔥 *Submit feedback!* \n\n"
        "━━━━━━━━━━━━━━━━━━━━━\n"
        "💠 *『 𝗔𝗗𝗠𝗜𝗡 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 』* 💠\n"
        "🔄 `/reset_cxt` - ⚙️ *Reset attack limits!*\n\n"
        "━━━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬:* [⚡ 𝐃𝐃𝐎𝐒𝐱𝐂𝐗𝐓™](https://t.me/DDOSxCXT) 💀\n"
    )
...
# 🔄 『 𝑹𝒆𝒔𝒆𝒕 𝑨𝒕𝒕𝒂𝒄𝒌 𝑳𝒊𝒎𝒊𝒕𝒔 』🔄
@bot.message_handler(commands=['reset_CXT'])
...
FEEDBACK_CHANNEL_ID = "-1002266739271"  # Replace with your actual feedback channel ID
...
PRIVATE_CHANNEL_USERNAME = "DDOSxCXTFEEDBACK"  # Example: "MyPrivateChannel"
PRIVATE_CHANNEL_LINK = "https://t.me/DDOSxCXTFEEDBACK"  # Replace with actual link
    ...
    try:
        ...
        if chat_member.status in ["member", "administrator", "creator"]:
            ...
            bot.send_message(
                ...
                "🔗 𝗬𝗼𝘂 𝗰𝗮𝗻 𝗻𝗼𝘄 𝗮𝗰𝗰𝗲𝘀𝘀 `/CXT` 𝘀𝗲𝗿𝘃𝗶𝗰𝗲𝘀! ⚡"
            )
        else:
            bot.send_message(
                message.chat.id,
...
# ⚠️ Modify /CXT to check live membership
@bot.message_handler(commands=['CXT'])
...
# Check if the number of running attacks is at the limit
    ...
    try:
        ...
        if len(args) != 3:
            raise ValueError("𝐃𝐃𝐎𝐒𝐱𝐂𝐗𝐓™ 𝘅 𝗗𝗶𝗟𝗗𝗢𝗦™ 𝗣𝗨𝗕𝗟𝗶𝗖 𝗕𝗢𝗧 𝗔𝗖𝗧𝗶𝗩𝗘 ✅ \n\n⚙ USE THIS 👇⬇️\n/CXT <IP> <PORT> <DURATION>")
        ...
        bot.send_message(
        message.chat.id,
            f"🚀𝙃𝙞 {message.from_user.first_name}, 𝘼𝙩𝙩𝙖𝙘𝙠 𝙨𝙩𝙖𝙧𝙩𝙚𝙙 𝙤𝙣 {target_ip} : {target_port} 𝙛𝙤𝙧 {default_duration} 𝙨𝙚𝙘𝙤𝙣𝙙𝙨. \n\n⚠️𝙍𝙀𝙈𝘼𝙄𝙉𝙄𝙉𝙂 𝘼𝙏𝙏𝘼𝘾𝙆𝙎 𝙁𝙊𝙍 𝙏𝙊𝘿𝘼𝙔⚠️ :- {remaining_attacks}\n\n★[𝔸𝕋𝕋𝔸ℂ𝕂𝔼ℝ 𝙉𝘼𝙈𝙀]★:- @{username}\n\n❗️❗️ 𝙋𝙡𝙚𝙖𝙨𝙚 𝙎𝙚𝙣𝙙 𝙁𝙚𝙚𝙙𝙗𝙖𝙘𝙠 ❗️❗️"
        )

        # Log the attack started message
        logging.info(f"Attack started by {user_name}: ./RAGNAROK {target_ip} {target_port} {default_duration} 900")
